...
public class SearchStateRBS : BaseST
{
    ...
    /* public SearchState(CC_SmartTankRBS newTank)
     {
         tank = newTank;
     }*/
    public override Type Entry()
    {
        // setting the fact about being in the search state to true 
    ...
    public override Type Exit()
    {
        ...
        // setting the fact about being in the search state to false
